...
public class CandidatesAdapter extends RecyclerView.Adapter<CandidatesAdapter.MyViewHolder>
{
    ...
    List<AppliedList> candidates;
    Context context;
    Activity activity;
    String type;
    ProgressDialog progressDialog;

    public CandidatesAdapter(List<AppliedList> candidates, Context context,String type) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int i) {
        ...
        final AppliedList appliedList=candidates.get(i);
       ...
       // holder.candidatesLayoutBinding.txtFollowers.setText(""+appliedList.);
        ...
        Log.d("Adaap",""+appliedList.getStatus());
        holder.candidatesLayoutBinding.txtAccept.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //Toast.makeText(context, ""+appliedList.getApplyId(), Toast.LENGTH_SHORT).show();
                updateApplyUserStatus(appliedList.getApplyId(),"1",i,holder);

            }
        });

        holder.candidatesLayoutBinding.txtReject.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                updateApplyUserStatus(appliedList.getApplyId(),"2",i,holder);
            }
        });
