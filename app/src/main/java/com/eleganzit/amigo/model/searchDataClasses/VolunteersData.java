...
public class VolunteersData {
    ...
    String volunteer_id,request_user_id,request_id,fullname,photo,followers,isFollowed,request_status,fail_status;

    public VolunteersData(String volunteer_id, String request_user_id, String request_id, String fullname, String photo, String followers, String isFollowed, String request_status, String fail_status) {
